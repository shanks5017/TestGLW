    ...
    <div className="w-full h-full flex flex-col justify-center gap-3 p-4">
        {['Netflix', 'Spotify', 'Google'].map((company, i) => (
            ...
            >
                ...
                <div className="text-[#0463c7] bg-[#E8F3FC] p-1.5 rounded-lg">
    ...
    return (
        <section className="bg-slate-100/50 relative overflow-hidden py-24 md:py-32">
            ...
            <div className="w-full mt-24 md:mt-32 flex justify-end overflow-hidden" ref={containerRef}>
                <motion.div
                    style={{ width, opacity }}
                    className="bg-[#0463c7] rounded-l-[15rem] rounded-r-none p-12 md:p-20 flex flex-col items-center justify-center text-center text-white relative overflow-hidden group ml-auto"
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <button className="flex items-center gap-3 bg-white text-[#0463c7] px-8 py-4 rounded-4xl font-bold text-lg hover:bg-[#E8F3FC] transition-all hover:scale-105 hover:shadow-xl duration-300 mx-auto">
