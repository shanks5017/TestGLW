    ...
    return (
        <section className="relative pt-28 pb-0 overflow-hidden bg-white selection:bg-primary/20 selection:text-primary min-h-screen flex flex-col justify-between">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 flex-grow w-full">
                ...
                <div className="grid lg:grid-cols-12 gap-6 lg:gap-4 items-center h-full pt-4 relative">
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-5 flex flex-col items-start text-left relative z-20 mt-12 lg:mt-20"
                    >
                    ...
                    <div className="lg:col-span-7 relative flex justify-start items-center h-[500px] lg:h-auto z-10 perspective-[3000px]">
                        <LaptopDisplay />
                    </div>
