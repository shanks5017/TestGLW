            ...
            <div className="max-w-7xl mx-auto px-6 relative h-full min-h-[500px] md:min-h-[600px] flex flex-col justify-center">
                ...
                >
                    <div className="w-40 h-32 bg-[#F5F3FF] rounded-full flex items-center justify-center shadow-sm">
                        <i className="fa-duotone fa-solid fa-suitcase text-[#0284C7] text-[56px] relative z-10 opacity-90"></i>
                    </div>
                </motion.div>
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <motion.h2
                        className="text-4xl md:text-[64px] font-normal text-[#5299E5] leading-[1.1] tracking-tight mb-10 md:mb-16"
                    >
                    ...
                    >
                        <div className="h-[3px] w-12 md:w-32 bg-gradient-to-r from-transparent to-[#5299E5] mt-2.5 md:mt-3.5" />
                        ...
                        <div className="h-[3px] w-12 md:w-32 bg-gradient-to-l from-transparent to-[#5299E5] mt-2.5 md:mt-3.5" />
                    </motion.div>
