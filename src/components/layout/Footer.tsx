        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-2 bg-gray-50 rounded-lg text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-all">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {FOOTER_LINKS.product.map((link) => (
                <li key={link.name}>
                  <Link to={link.href} className="text-slate-500 hover:text-blue-600 text-sm transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
