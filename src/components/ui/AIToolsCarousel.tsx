      ...
      mockupContent: (
        <div className="bg-black rounded-lg p-4 shadow-sm">
          <div className="flex items-center space-x-3 mb-3">
            <div className="w-12 h-12 bg-[#0463c7] rounded-full flex items-center justify-center">
              <User className="w-6 h-6 text-white" />
            </div>
            <div>
              <div className="h-3 bg-[#0463c7] rounded w-24 mb-1"></div>
        ...
        <div className="bg-black rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              <Chrome className="w-4 h-4 text-[#0463c7]" />
              <span className="text-xs font-medium text-white">Chrome Extension</span>
            </div>
            <div className="w-2 h-2 bg-[#0463c7] rounded-full"></div>
          </div>
          <div className="space-y-2">
            <div className="h-2 bg-gray-700 rounded w-full"></div>
            <div className="h-2 bg-gray-700 rounded w-2/3"></div>
            <div className="h-2 bg-[#0352a8] rounded w-1/2"></div>
          </div>
        </div>
      )
    },
    {
      ...
      mockupContent: (
        <div className="bg-black rounded-lg p-4 shadow-sm">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-[#0463c7] rounded-full flex items-center justify-center">
      ...
      mockupContent: (
        <div className="bg-black rounded-lg p-4 shadow-sm">
          <div className="flex items-center space-x-2 mb-3">
            <FileText className="w-4 h-4 text-[#0463c7]" />
            ...
            <div className="ml-auto w-8 h-8 bg-[#D6EAFF] rounded-full flex items-center justify-center">
              <Zap className="w-4 h-4 text-[#0463c7]" />
            </div>
          </div>
