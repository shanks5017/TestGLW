...
export function ResumeOptimizerMockup() {
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 min-h-[400px] relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm text-center">
            ...
            <button className="bg-[#0352a8] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#2A74C9] transition-colors">
              TAILOR TO JOB
            </button>
          </div>
        </div>
      ...
      {/* Floating AI Badge */}
      <div className="absolute top-4 right-4 bg-[#0352a8] text-white px-3 py-1 rounded-full text-xs font-medium flex items-center space-x-1">
