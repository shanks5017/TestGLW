...
export function Support() {
  return (
    <div className="bg-white pt-20 pb-20">
      ...
      {/* Header */}
      <div className="bg-[#EFF4FF] py-24 mb-20">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-[#171717] mb-6">How can we help?</h1>
          <div className="relative max-w-lg mx-auto">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
            <input
              type="text"
              placeholder="Search for answers..."
              className="w-full pl-12 pr-4 py-4 rounded-full border border-gray-200 outline-none focus:border-[#0040C1] focus:ring-4 focus:ring-blue-50 transition-all shadow-sm"
            />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            ...
            >
              <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6 text-[#171717]">
                <item.icon className="w-6 h-6" />
              </div>
              <h3 className="font-bold text-lg mb-2 text-[#171717]">{item.title}</h3>
        ...
        {/* FAQ */}
        <div className="mb-24">
          <h2 className="text-3xl font-bold text-[#171717] mb-12 text-center">Frequently Asked Questions</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="p-6 rounded-[24px] border border-gray-100 flex justify-between items-center hover:bg-gray-50 cursor-pointer">
                <span className="font-semibold text-[#171717] text-lg">{q}</span>
        ...
        <div className="bg-gray-50 rounded-[48px] p-12 md:p-16">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-[#171717] mb-8 text-center">Still need help?</h2>
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-[#171717] ml-2">Name</label>
                  <input type="text" className="w-full px-6 py-4 rounded-2xl border-none bg-white shadow-sm" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-[#171717] ml-2">Email</label>
                  <input type="email" className="w-full px-6 py-4 rounded-2xl border-none bg-white shadow-sm" placeholder="john@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#171717] ml-2">Message</label>
