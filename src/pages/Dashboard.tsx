    ...
    <div className="min-h-screen bg-gray-50 flex font-sans text-[#171717]">
      ...
      <div className="w-64 bg-white border-r border-gray-100 p-6 flex-col hidden md:flex sticky top-0 h-screen">
        <div className="flex items-center gap-3 mb-12 px-2">
          <div className="w-8 h-8 bg-[#0040C1] rounded-lg flex items-center justify-center text-white font-bold">G</div>
        ...
        <div className="p-4 bg-blue-50 rounded-2xl">
          <h4 className="font-bold text-[#0040C1] mb-2 text-sm">Pro Plan</h4>
          <p className="text-xs text-blue-600 mb-3">You have 5 premium scans remaining.</p>
          <button className="text-xs font-bold text-[#0040C1] hover:underline">Upgrade Now</button>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-gray-50 flex items-center justify-between">
                ...
                <button className="text-sm font-semibold text-[#0040C1] hover:underline">View All</button>
              </div>
              <div className="p-6">
              ...
              <div className="bg-[#171717] rounded-[32px] p-8 text-white relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full bg-[#0040C1] w-[80%]" />
                  </div>
                </div>
                {/* Decor */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#0040C1] rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 opacity-50" />
              </div>
              ...
              <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-12 h-12 rounded-2xl bg-blue-50 flex flex-col items-center justify-center text-[#0040C1] shrink-0">
                      <span className="text-xs font-bold uppercase">Oct</span>
